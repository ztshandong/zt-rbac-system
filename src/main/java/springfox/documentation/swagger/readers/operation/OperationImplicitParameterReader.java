...
public class OperationImplicitParameterReader implements OperationBuilderPlugin {
    ...
    static Parameter implicitParameter(DescriptionResolver descriptions, ApiImplicitParam param) {
        ...
        return new ParameterBuilder()
                ...
                .modelRef(modelRef)
                .allowableValues(allowableValueFromString("enumName".equalsIgnoreCase(param.name()) ? ZtSpringUtil.getEnumName().keySet().toString().replace("[", "").replace("]", "") : param.allowableValues()))
