    ...
    GenerateRoutes({
      ...
      return new Promise((resolve, reject) => {
        ...
        getRouters().then(res => {
          ...
          // console.log('路由数据:' + JSON.stringify(sdata))
          ...
          // console.log('commitrewriteRoutes')
          commit('SET_ROUTES', rewriteRoutes)
          // console.log('commitsidebarRoutes')
          commit('SET_SIDEBAR_ROUTERS', sidebarRoutes)
          // console.log('sidebarRoutes:' + JSON.stringify(sidebarRoutes))
          resolve(rewriteRoutes)
        }).catch(error => {
          console.log('getRoutersError:' + error)
          reject(error)
        })
      })
    }
